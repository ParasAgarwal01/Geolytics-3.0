...
from .views import (
    ...
    SavePolygonViews,
    ListUserPolygonView,ProjectConfigurationListView,KPIFailurePerTechView,
)
...
urlpatterns = [
    ...
    path('geo-api/polygon/save_polygon',SavePolygonViews.as_view()),
    path('geo-api/polygon/user_polygon_list',ListUserPolygonView.as_view()),
    path('kpi-failure-tech', KPIFailurePerTechView.as_view()),
    path('geo-api/kpi-failure-tech', KPIFailurePerTechView.as_view()),
    path('geo-api/polygon/project_configration',ProjectConfigurationListView.as_view())
