...
const Sidebar = ({
  ...
  useEffect(() => {
    if (
      ...
      const opts = geoJsonData.features
        .map((f) => {
          const props = f.properties || {};
          const bandRaw =
      ...
      <div className="sidebar-scroll">
        ...
        {layerColumn && colorRanges[layerColumn] && (
          <div className="color-range-wrapper" style={{ marginTop: 10 }}>
            {Object.entries(colorRanges[layerColumn]).map(
              ([color, [min, max]]) => (
                <div
                  key={color}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setColorRanges((prev) => ({
                      ...
                      [layerColumn]: {
                        ...prev[layerColumn],
                        [name]: [Number(newColorMin), Number(newColorMax)],
                      },
                    }));
    ...
    >
      ...
      >
        ...
        {selectedGridKPI && colorRanges[selectedGridKPI] && (
          <div className="color-range-wrapper">
            {Object.entries(colorRanges[selectedGridKPI]).map(
              ([color, [min, max]]) => (
                <div
                  key={color}
                  className="color-range-row"
